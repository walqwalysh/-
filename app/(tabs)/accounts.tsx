...
export default function AccountsScreen() {
  ...
  async function saveAccount() {
    try { setSaving(true); await addAccount(name, category); setName(""); setCategory("asset"); setModalOpen(false); }
        ...
        <View style={styles.overlay}>
          <View style={styles.sheet}>
            <View style={styles.sheetHeader}>
              <Pressable onPress={() => setModalOpen(false)}><MaterialIcons name="close" size={24} color="#65737E" /></Pressable>
              <Text style={styles.sheetTitle}>إضافة حساب</Text>
            </View>
            <Text style={styles.fieldLabel}>اسم الحساب</Text>
            <TextInput value={name} onChangeText={setName} placeholder="مثال: صندوق النقد" placeholderTextColor="#98A5AE" style={styles.input} textAlign="right" returnKeyType="done" />
...
const styles = StyleSheet.create({
  header: { alignItems: "center", flexDirection: "row-reverse", justifyContent: "space-between", marginBottom: 15, paddingTop: 10 }, eyebrow: { color: "#65737E", fontSize: 12, fontWeight: "600", textAlign: "right", writingDirection: "rtl" }, title: { color: "#14212B", fontSize: 26, fontWeight: "800", lineHeight: 35, textAlign: "right", writingDirection: "rtl" }, addSquare: { alignItems: "center", backgroundColor: "#154C79", borderRadius: 14, height: 44, justifyContent: "center", width: 44 },
  list: { gap: 10, paddingBottom: 20 }, emptyList: { flexGrow: 1, justifyContent: "center", paddingBottom: 80 }, accountCard: { alignItems: "center", backgroundColor: "#FFFFFF", borderColor: "#E1E8EE", borderRadius: 18, borderWidth: 1, flexDirection: "row-reverse", gap: 12, padding: 14 }, accountInfo: { alignItems: "flex-end", flex: 1 }, accountName: { color: "#14212B", fontSize: 16, fontWeight: "700", writingDirection: "rtl" }, accountCategory: { color: "#65737E", fontSize: 12, marginTop: 3, writingDirection: "rtl" }, balance: { fontSize: 13, fontWeight: "800", writingDirection: "rtl" },
  overlay: { backgroundColor: "rgba(20,33,43,0.35)", flex: 1, justifyContent: "flex-end" }, sheet: { backgroundColor: "#FFFFFF", borderTopLeftRadius: 28, borderTopRightRadius: 28, gap: 10, padding: 20, paddingBottom: 34 }, sheetHeader: { alignItems: "center", flexDirection: "row", justifyContent: "space-between", marginBottom: 4 }, sheetTitle: { color: "#14212B", fontSize: 20, fontWeight: "800", writingDirection: "rtl" }, fieldLabel: { color: "#33454F", fontSize: 13, fontWeight: "700", textAlign: "right", writingDirection: "rtl" }, input: { backgroundColor: "#F6F8FA", borderColor: "#E1E8EE", borderRadius: 14, borderWidth: 1, color: "#14212B", fontSize: 16, minHeight: 52, paddingHorizontal: 14, writingDirection: "rtl" }, chips: { flexDirection: "row-reverse", flexWrap: "wrap", gap: 8, marginBottom: 8 }, chip: { borderColor: "#E1E8EE", borderRadius: 20, borderWidth: 1, paddingHorizontal: 12, paddingVertical: 8 }, chipText: { color: "#65737E", fontSize: 13, fontWeight: "700", writingDirection: "rtl" }, pressed: { opacity: 0.78, transform: [{ scale: 0.98 }] },
});
